 ...
 */
declare class NepalTimezoneDate {
    private _date;
     ...
     */
    private static getNepalDateAndTime;
    /**
...
declare class NepaliDate {
     ...
     */
    static fromEnglishDate(year: number, month: number, date: number, hour?: number, minute?: number, second?: number, ms?: number): NepaliDate;
    /**
